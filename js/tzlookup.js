/* tzlookup.js — Offline lat/lon → IANA timezone (tz-lookup v6)
 * Adapted from https://github.com/photostructure/tz-lookup
 * Browser-compatible global script — no Node.js, no dependencies, < 80 KB.
 * Loaded as a plain <script> before citySearch.js; exposes tzlookup() globally.
 *
 * Usage:  tzlookup(lat, lon)  →  "Asia/Kolkata"
 * Errors: throws RangeError on invalid coordinates (never returns null).
 */
/* global tzlookup */
...
/* tzlookup is now a global function available to all subsequent scripts. */
